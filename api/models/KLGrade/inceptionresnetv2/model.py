...
def create_model():
    ...
    predictions = layers.Reshape((-1,), name="predictions_preFlatten1")(avg_pool)
    predictions = layers.Dense(5, name="predictions_")(predictions)
    predictions_softmax = layers.Softmax()(predictions)

    model = keras.Model(inputs=[input_1_unnormalized], outputs=[predictions_softmax])
    return model
